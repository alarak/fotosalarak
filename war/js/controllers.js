angular.module('fotosApp.controllers', []).controller('AlbumController', function($scope, $state, popupService, $window, Movie) {
...
}).controller('AlbumViewController', function($scope, $stateParams, Movie) {
...
}).controller('AlbumEditController', function($scope, $state, $stateParams, Movie) {
